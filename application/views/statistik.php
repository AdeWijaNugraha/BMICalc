 ...
 <html>  
  <head>
        ...
        var data = google.visualization.arrayToDataTable([  
          ['Interpretasi', 'Number'],  
            ...
            foreach ($result as $row) {
              echo "['".$row->interpretasi."', ".$row->number."],";
            }
            ?>  
          ]);  
        var options = {   
    ...
    <div id="fh5co-work-section" style="background-image: url(<?php echo base_url('assets'); ?>/images/back4.png);">
      <div class="container" style="background-color: rgba(247, 247, 247, 0.7); border-radius: 5px;padding: 5px;">
        <center>
          <h2 style="color: #000;">Prosentase Seluruh Data Berdasarkan Klasifikasi IMT</h2>
          <div style="width:900px;">
            <center>
              <div id="piechart" style="width: 900px; height: 500px;"></div>
            </center>
          </div>
          <h3 style="color: #000;">Jumlah Data : <?php echo $jumlah?></h3>
        </center>
      </div>
    </div>
</div>
